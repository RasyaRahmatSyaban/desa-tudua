                            ...
                            @forelse($penduduk as $item)
                                <tr class="hover:bg-gray-50">
                                    ...
                                    <td class="px-6 py-4 whitespace-nowrap">
                                        <span
                                            class="px-2 py-1 text-xs font-medium {{ $item->jenis_kelamin === 'Laki-laki' ? 'bg-blue-100 text-blue-800' : 'bg-pink-100 text-pink-800' }} rounded-full">
                                            <i
                                                class="fas fa-{{ $item->jenis_kelamin === 'Laki-laki' ? 'male' : 'female' }} mr-1"></i>
