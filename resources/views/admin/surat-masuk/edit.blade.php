            ...
            <form action="{{ route('admin.surat-masuk.update', $suratMasuk->id) }}" method="POST"
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    ...
                    <div>
                        ...
                        <input type="text" id="pengirim" name="pengirim"
                            value="{{ old('pengirim', $suratMasuk->pengirim) }}" class="w-full px-4 py-3 border rounded-lg"
                            @error('pengirim') border-red-500 @enderror required>
                        @error('pengirim')
                            <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
                        @enderror
                    </div>
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    ...
                    <div>
                        ...
                        <input type="text" id="perihal" name="perihal" value="{{ old('perihal', $suratMasuk->perihal) }}"
                    ...
                    <div>
                        ...
                        <input type="date" id="tanggal_terima" name="tanggal_terima"
                            ...
                            class="w-full px-4 py-3 border rounded-lg" @error('tanggal_terima') border-red-500 @enderror
                            required>
                ...
                <div class="space-y-2">
                    ...
                    @endif
                    <input type="file" id="file" name="file" accept=".pdf,.doc,.docx" @error('file') border-red-500
                    @enderror
