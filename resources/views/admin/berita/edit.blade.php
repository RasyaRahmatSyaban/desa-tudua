                    ...
                    <div class="lg:col-span-2 space-y-6">
                        ...
                        <div>
                            ...
                            <textarea id="isi" name="isi" rows="12"
                                class="w-full px-4 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent"
                                @error('isi') border-red-500 @enderror placeholder="Tulis konten berita di sini..."
                        ...
                        <div>
                            ...
                            <input type="text" id="penulis" name="penulis" value="{{ old('penulis', $berita->penulis) }}"
                                class="w-full px-4 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent"
                                @error('penulis') border-red-500 @enderror placeholder="Nama penulis" required>
                            @error('penulis')
                                <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
                            @enderror
                        </div>
                    ...
                    <div class="space-y-6">
                        ...
                        <div>
                            ...
                            <div
                                ...
                                <input type="file" id="foto" name="foto" accept="image/*" class="hidden"
                                    value="{{ old('foto', $berita->foto) }}" onchange="previewImage(this)">
                        ...
                        <div>
                            ...
                            <input type="date" id="tanggal_terbit" name="tanggal_terbit"
                                ...
                                class="w-full px-4 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent"
                                @error('tanggal_terbit') border-red-500 @enderror required>
