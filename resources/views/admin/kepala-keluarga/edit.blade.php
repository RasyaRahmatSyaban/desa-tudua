                ...
                <div class="page-title-box">
                    <div class="page-title-right">
                        <ol class="breadcrumb m-0">
                            ...
                            <li class="breadcrumb-item"><a href="{{ route('admin.kepala-keluarga.index') }}">Kepala
                                    Keluarga</a></li>
                        ...
                        <form action="{{ route('admin.kepala-keluarga.update', $kepalaKeluarga->id) }}" method="POST">
                                ...
                                <div class="col-md-6">
                                    <div class="mb-3">
                                        ...
                                        <input type="text" class="form-control @error('no_kk') is-invalid @enderror"
                                            id="no_kk" name="no_kk" value="{{ old('no_kk', $kepalaKeluarga->no_kk) }}"
                                            required>
                                        @error('no_kk')
                                ...
                                <div class="col-md-6">
                                    <div class="mb-3">
                                        ...
                                        <input type="text" class="form-control @error('nik') is-invalid @enderror" id="nik"
                                            name="nik" value="{{ old('nik', $kepalaKeluarga->nik) }}" required>
                                        @error('nik')
                                            <div class="invalid-feedback">{{ $message }}</div>
                                        @enderror
                                    </div>
                                ...
                                <div class="col-md-6">
                                    <div class="mb-3">
                                        ...
                                        <input type="text" class="form-control @error('tempat_lahir') is-invalid @enderror"
                                            ...
                                            value="{{ old('tempat_lahir', $kepalaKeluarga->tempat_lahir) }}" required>
                                        @error('tempat_lahir')
                                            <div class="invalid-feedback">{{ $message }}</div>
                                        @enderror
                                    </div>
                                ...
                                <div class="col-md-6">
                                    <div class="mb-3">
                                        ...
                                        <input type="date" class="form-control @error('tanggal_lahir') is-invalid @enderror"
                                            ...
                                            value="{{ old('tanggal_lahir', $kepalaKeluarga->tanggal_lahir ? $kepalaKeluarga->tanggal_lahir->format('Y-m-d') : '') }}"
                                            required>
                                        @error('tanggal_lahir')
                                            <div class="invalid-feedback">{{ $message }}</div>
                                        @enderror
                                ...
                                <div class="col-md-6">
                                    <div class="mb-3">
                                        ...
                                        <select class="form-select @error('pendidikan') is-invalid @enderror"
                                            ...
                                            <option value="Tidak Sekolah" {{ old('pendidikan', $kepalaKeluarga->pendidikan) == 'Tidak Sekolah' ? 'selected' : '' }}>Tidak
                                                Sekolah</option>
                                ...
                                <div class="col-md-6">
                                    <div class="mb-3">
                                        ...
                                        <input type="text" class="form-control @error('pekerjaan') is-invalid @enderror"
                                            ...
                                            value="{{ old('pekerjaan', $kepalaKeluarga->pekerjaan) }}">
                                        @error('pekerjaan')
                                            <div class="invalid-feedback">{{ $message }}</div>
                                        @enderror
                                    </div>
                                ...
                                <div class="col-md-6">
                                    <div class="mb-3">
                                        ...
                                        <select class="form-select @error('status_kawin') is-invalid @enderror"
                                            ...
                                            <option value="Belum Kawin" {{ old('status_kawin', $kepalaKeluarga->status_kawin) == 'Belum Kawin' ? 'selected' : '' }}>Belum
                                                Kawin</option>
                                            <option value="Kawin" {{ old('status_kawin', $kepalaKeluarga->status_kawin) == 'Kawin' ? 'selected' : '' }}>Kawin</option>
                                            <option value="Cerai Hidup" {{ old('status_kawin', $kepalaKeluarga->status_kawin) == 'Cerai Hidup' ? 'selected' : '' }}>Cerai
                                                Hidup</option>
                                            <option value="Cerai Mati" {{ old('status_kawin', $kepalaKeluarga->status_kawin) == 'Cerai Mati' ? 'selected' : '' }}>Cerai Mati
                                            </option>
                                        </select>
                                        @error('status_kawin')
                                            <div class="invalid-feedback">{{ $message }}</div>
                            ...
                            <div class="mb-3">
                                ...
                                <textarea class="form-control @error('alamat') is-invalid @enderror" id="alamat"
                                    name="alamat" rows="3" required>{{ old('alamat', $kepalaKeluarga->alamat) }}</textarea>
                                @error('alamat')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                            </div>
                                ...
                                <div class="col-md-4">
                                    <div class="mb-3">
                                        ...
                                        <input type="text" class="form-control @error('rt') is-invalid @enderror" id="rt"
                                            name="rt" value="{{ old('rt', $kepalaKeluarga->rt) }}">
                                        @error('rt')
                                            <div class="invalid-feedback">{{ $message }}</div>
                                        @enderror
                                    </div>
                                ...
                                <div class="col-md-4">
                                    <div class="mb-3">
                                        ...
                                        <input type="text" class="form-control @error('rw') is-invalid @enderror" id="rw"
                                            name="rw" value="{{ old('rw', $kepalaKeluarga->rw) }}">
                                        @error('rw')
                                            <div class="invalid-feedback">{{ $message }}</div>
                                        @enderror
                                    </div>
