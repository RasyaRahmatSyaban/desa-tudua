...
@section('content')
    <div class="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="flex flex-col sm:flex-row sm:items-center sm:justify-between mb-6">
            ...
            <a href="{{ route('admin.kepala-keluarga.index') }}"
                ...
                <form action="{{ route('admin.kepala-keluarga.store') }}" method="POST">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                        <div>
                            ...
                            <input type="text"
                                class="w-full px-4 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent" @error('no_kk') border-red-500 @enderror
                        ...
                        <div>
                            ...
                            <input type="text"
                                class="w-full px-4 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent" @error('nik_kepala_keluarga') border-red-500 @enderror
                                id="nik_kepala_keluarga" name="nik_kepala_keluarga" value="{{ old('nik_kepala_keluarga') }}"
                                required>
                    ...
                    <div class="mt-6">
                        ...
                        <input type="text"
                            class="w-full px-4 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent" @error('nama_kepala_keluarga') border-red-500 @enderror
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-3 gap-6 mt-6">
                        ...
                        <div>
                            ...
                            <select
                                class="w-full px-4 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent" @error('dusun') border-red-500 @enderror
                                id="dusun" name="dusun" required>
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6 mt-6">
                        ...
                        <div>
                            ...
                            <input type="number"
                                class="w-full px-4 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent" @error('jumlah_anggota') border-red-500 @enderror
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6 mt-6">
                        <div>
                            ...
                            <input type="date"
                            class="w-full px-4 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent" @error('tanggal_terdaftar') border-red-500 @enderror
                            id="tanggal_terdaftar" name="tanggal_terdaftar"
                                value="{{ old('tanggal_terdaftar', date('Y-m-d')) }}">
