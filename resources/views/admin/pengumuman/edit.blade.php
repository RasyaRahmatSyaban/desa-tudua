                    ...
                    <div class="lg:col-span-2 space-y-6">
                        ...
                        <div>
                            ...
                            <input type="text" id="judul" name="judul" value="{{ old('judul', $pengumuman->judul) }}"
                                ...
                                @error('judul') border-red-500 @enderror placeholder="Masukkan judul pengumuman..."
                                required>
                            @error('judul')
                        ...
                        <div>
                            ...
                            <textarea id="isi" name="isi" rows="10"
                                class="w-full px-4 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent"
                                @error('isi') border-red-500 @enderror placeholder="Tulis isi pengumuman di sini..."
                    ...
                    <div class="space-y-6">
                        ...
                        <div>
                            ...
                            <input type="date" id="berlaku_hingga" name="berlaku_hingga"
                                ...
                                class="w-full px-4 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent"
                                @error('berlaku_hingga') border-red-500 @enderror required>
