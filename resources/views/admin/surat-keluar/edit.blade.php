...
<div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 space-y-6">
    ...
    <div class="bg-white rounded-lg shadow-md p-6">
        ...
        <form action="{{ route('admin.surat-keluar.update', $suratKeluar->id) }}" method="POST" enctype="multipart/form-data" class="space-y-6">
            @csrf
            @method('PUT')
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <div>
                    ...
                    <input type="text" id="penerima" name="penerima"
                           ...
                           class="w-full px-4 py-3 border rounded-lg @error('penerima') border-red-500 @enderror"
                           required>
                    @error('penerima')
                        <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
                    @enderror
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <div>
                    ...
                    <input type="text" id="perihal" name="perihal"
                           ...
                           class="w-full px-4 py-3 border rounded-lg @error('perihal') border-red-500 @enderror"
                           required>
                    @error('perihal')
                        <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
                    @enderror
