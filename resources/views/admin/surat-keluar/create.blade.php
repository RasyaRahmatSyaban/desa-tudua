                ...
                <form action="{{ route('admin.surat-keluar.store') }}" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                        <div>
                            ...
                            <input type="text"
                                ...
                                value="{{ old('nomor_surat') }}" placeholder="0XX/X/20XX" required>
                            @error('nomor_surat')
                        ...
                        <div>
                            ...
                            <input type="date"
                                class="w-full px-4 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent"
                                @error('tanggal_kirim') border-red-500 @enderror id="tanggal_kirim" name="tanggal_kirim"
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6 mt-6">
                        ...
                        <div>
                            ...
                            <input type="text"
                                class="w-full px-4 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent"
                                @error('penerima') border-red-500 @enderror id="penerima" name="penerima"
                                value="{{ old('penerima') }}" placeholder="Nama instansi/organisasi penerima" required>
                            @error('penerima')
                                <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
                            @enderror
                        </div>
