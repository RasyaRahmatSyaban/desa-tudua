        ...
        <div class="bg-white rounded-xl shadow-sm border border-slate-200">
            <div class="p-6">
                <div class="flex items-center space-x-3 mb-6 pb-6 border-b border-slate-200">
                    <div>
                        <h3 class="text-lg font-semibold text-slate-800">Informasi Pelayanan</h3>
                    </div>
                </div>
                    ...
                    <div class="grid grid-cols-1 gap-6">
                        ...
                        <div>
                            ...
                            <textarea name="deskripsi" id="deskripsi" rows="4"
                                ...
                                placeholder="Deskripsikan pelayanan ini secara singkat dan jelas...">{{ old('deskripsi') }}</textarea>
                            @error('deskripsi')
                                <p class="mt-2 text-sm text-red-600 flex items-center">
                                    <i class="fas fa-exclamation-circle mr-1 text-xs"></i>
                                    {{ $message }}
