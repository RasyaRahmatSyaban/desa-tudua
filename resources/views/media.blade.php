...
@section('content')
    ...
    <section class="py-8 pt-24 bg-gray-900 border-b border-gray-700">
        <div class="w-full mx-auto px-6 md:px-12 lg:px-24 flex flex-row items-center justify-between">
            <div>
                <h2 class="text-2xl lg:text-3xl font-bold text-white mb-2">Media Desa</h2>
                <p class="text-gray-400 text-base">Kumpulan dokumentasi desa dalam bentuk foto, video, dan dokumen</p>
            </div>
            <form method="GET" action="{{ route('media') }}" class="flex flex-col md:flex-row items-center justify-between gap-6">
